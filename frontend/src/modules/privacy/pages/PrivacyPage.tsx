...
export function PrivacyPage() {
  ...
  return <main className="public-page privacy-page">
    <header className="public-page-header"><Link to="/login">← Volver</Link><span>SGTB Incalpaca</span><h1>Privacidad y datos personales</h1><p>Información clara sobre el tratamiento de datos y un canal para ejercer derechos ARCO.</p></header>
