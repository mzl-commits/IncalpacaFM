...
import { autocompletarCostosMateriales, updateWorkOrderCostAmount } from "@/modules/workorders/workOrderMaterialRepository";
...
export function WorkOrderReportsPage() {
  ...
  async function handleAutocompletar() {
    ...
    try {
      ...
      setMessage("Costos autocompletados desde materiales del técnico.");
    } catch {
        ...
        <header>
          <div>
            ...
            <div>
              ...
              <p>Registro manual para el informe final.</p>
            </div>
          </div>
