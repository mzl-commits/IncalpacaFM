            ...
            <div className="form-grid">
                ...
                <input
                  ...
                  onChange={(event) => {
                    ...
                    setInput((current) => ({
                      ...
                      preventiveFrequencyMonths: checked ? current.preventiveFrequencyMonths : null,
                    }));
                  }}
                />
                <span>
              ...
              <label className="switch-row">
                <input
                  ...
                  disabled={input.reviewStatus === "REVIEW"}
                ...
                <span>
                  ...
                  <small>
                    {input.reviewStatus === "REVIEW"
                      ? "Deshabilitado mientras la taxonomía esté en revisión."
                      : "Si se desactiva, la taxonomía sigue visible pero no puede usarse en nuevas entradas."}
                  </small>
                </span>
              </label>
            </div>
