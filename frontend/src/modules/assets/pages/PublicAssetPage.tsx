import { Buildings, Camera, CheckCircle, ClockCounterClockwise, MapPin, ShieldCheck, Siren, Tag } from "@phosphor-icons/react";
...
export function PublicAssetPage() {
  ...
  return <main className="public-page"><section className="public-card">
    ...
    <div className="public-asset-photo">
      {asset.photo_url
        ? <img src={asset.photo_url} alt={`Fotografía registrada de ${asset.name}`} />
        : <div><Camera size={40} weight="duotone" /><span>Fotografía pendiente</span></div>}
    </div>
    ...
    {asset.service_tracking && <section className="public-tracking" aria-labelledby="public-tracking-title">
      <div className="public-tracking-heading"><ClockCounterClockwise size={21} /><div><h2 id="public-tracking-title">Seguimiento de tu reporte</h2><p>Estado actual: <strong>{asset.service_tracking.current_label}</strong></p></div></div>
