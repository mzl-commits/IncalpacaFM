...
export function AssetScannerPage() {
  ...
  function openResult(value: string) {
    ...
    if (!token) {
      setCameraError("El código leído no corresponde a un QR de bienes SGTB. Usa el enlace público o el identificador del QR.");
      setScanning(false);
      return;
    }
  ...
  async function readImage(file?: File) {
    ...
    catch { setCameraError("No encontramos un QR legible de SGTB en la imagen."); }
