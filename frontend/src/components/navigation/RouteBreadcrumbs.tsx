...
const routeMap: Array<{ match: RegExp; crumbs: RouteCrumb[] }> = [
  ...
  { match: /^\/administracion\/espacios\/nuevo$/, crumbs: [{ label: "Administración" }, { label: "Espacios y ambientes", to: "/administracion/espacios" }, { label: "Nuevo" }] },
  { match: /^\/administracion\/espacios\/[^/]+\/editar$/, crumbs: [{ label: "Administración" }, { label: "Espacios y ambientes", to: "/administracion/espacios" }, { label: "Editar" }] },
  { match: /^\/administracion\/espacios\/[^/]+$/, crumbs: [{ label: "Administración" }, { label: "Espacios y ambientes", to: "/administracion/espacios" }, { label: "Detalle" }] },
  { match: /^\/administracion\/espacios$/, crumbs: [{ label: "Administración" }, { label: "Espacios y ambientes" }] },
